...
function GeneratePaySlipForm({ onClose }) {
                ...
                <Box sx={{
                    ...
                    <Box>
                        ...
                        >
                            {dummyEmployeeData.map((employee) => (
                                <MenuItem value={employee._id}>{employee.firstName} {employee.lastName} ({employee.position})</MenuItem>
                            ))}
                    ...
                    <Box sx = {{
                        ...
                        <Box sx = {{width : "100%"}}>
                            ...
                            <TextField name="allowance" size='small'
                            sx = {{ "& .MuiInputBase-root":{
                                padding : "1px 3px"
                            }, mt : 1 }}
                            type='number' fullWidth 
